...
<div id="login-container" class="animation-fadeIn">
    ...
    <div class="block remove-margin">
        <!-- Login Form -->
        <form action="validate.php" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">
        ...
        <!-- Register Form -->
        <form action="validate.php" method="post" id="form-register" class="form-horizontal form-bordered form-control-borderless display-none" onsubmit="return false;">
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="input-group">
